 ...
 * @name Color
 * @package google.type
 * @see proto type: google.type.Color
 */
...
export const Color = {
  ...
  fromPartial<I extends Exact<Partial<Color>, I>>(object: I): Color {
    const message = createBaseColor();
  ...
  registerTypeUrl() {
    if (!GlobalDecoderRegistry.registerExistingTypeUrl(Color.typeUrl)) {
      return;
    }
    FloatValue.registerTypeUrl();
  }
};