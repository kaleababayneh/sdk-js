...
/**
 * Request object for ByteStream.QueryWriteStatus.
 * @name QueryWriteStatusRequestAmino
 * @package google.bytestream
 * @see proto type: google.bytestream.QueryWriteStatusRequest
 */
...
/**
 * Response object for ByteStream.QueryWriteStatus.
 * @name QueryWriteStatusResponseAmino
 * @package google.bytestream
 * @see proto type: google.bytestream.QueryWriteStatusResponse
 */
...
export const ReadRequest = {
  ...
  fromAmino(object: ReadRequestAmino): ReadRequest {
    ...
    if (object.read_offset !== undefined && object.read_offset !== null) {
      message.readOffset = BigInt(object.read_offset);
    }
    if (object.read_limit !== undefined && object.read_limit !== null) {
      message.readLimit = BigInt(object.read_limit);
    }
    return message;
  },
  toAmino(message: ReadRequest): ReadRequestAmino {
    ...
    obj.read_offset = message.readOffset !== BigInt(0) ? message.readOffset?.toString() : undefined;
    obj.read_limit = message.readLimit !== BigInt(0) ? message.readLimit?.toString() : undefined;
    return obj;
  },
...
export const WriteRequest = {
  ...
  fromAmino(object: WriteRequestAmino): WriteRequest {
    ...
    if (object.write_offset !== undefined && object.write_offset !== null) {
      message.writeOffset = BigInt(object.write_offset);
    }
    if (object.finish_write !== undefined && object.finish_write !== null) {
      message.finishWrite = object.finish_write;
    }
    if (object.data !== undefined && object.data !== null) {
      message.data = bytesFromBase64(object.data);
    }
  ...
  toAmino(message: WriteRequest): WriteRequestAmino {
    const obj: any = {};
    obj.resource_name = message.resourceName === "" ? undefined : message.resourceName;
    obj.write_offset = message.writeOffset !== BigInt(0) ? message.writeOffset?.toString() : undefined;
    obj.finish_write = message.finishWrite === false ? undefined : message.finishWrite;
    obj.data = message.data ? base64FromBytes(message.data) : undefined;
    return obj;
  },
...
export const WriteResponse = {
  ...
  fromAmino(object: WriteResponseAmino): WriteResponse {
    const message = createBaseWriteResponse();
    if (object.committed_size !== undefined && object.committed_size !== null) {
      message.committedSize = BigInt(object.committed_size);
    }
    return message;
  },
  toAmino(message: WriteResponse): WriteResponseAmino {
    const obj: any = {};
    obj.committed_size = message.committedSize !== BigInt(0) ? message.committedSize?.toString() : undefined;
    return obj;
  },
...
export const QueryWriteStatusResponse = {
  ...
  toAmino(message: QueryWriteStatusResponse): QueryWriteStatusResponseAmino {
    const obj: any = {};
    obj.committed_size = message.committedSize !== BigInt(0) ? message.committedSize?.toString() : undefined;
    obj.complete = message.complete === false ? undefined : message.complete;
    return obj;
  },
