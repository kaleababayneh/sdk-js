...
export class QueryClientImpl implements Query {
  ...
  /* List actions for a specific supernode. */
  listActionsBySuperNode = async (request: QueryListActionsBySuperNodeRequest): Promise<QueryListActionsResponse> => {
  ...
  /* List actions created at a specific block height. */
  listActionsByBlockHeight = async (request: QueryListActionsByBlockHeightRequest): Promise<QueryListActionsResponse> => {
  ...
  /* Query actions based on metadata. */
  queryActionByMetadata = async (request: QueryActionByMetadataRequest): Promise<QueryListActionsResponse> => {
