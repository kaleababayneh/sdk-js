...
export const QueryConstitutionRequest = {
  ...
  fromPartial<I extends Exact<Partial<QueryConstitutionRequest>, I>>(_: I): QueryConstitutionRequest {
    const message = createBaseQueryConstitutionRequest();
    return message;
  },
...
export const QueryConstitutionResponse = {
  ...
  fromPartial<I extends Exact<Partial<QueryConstitutionResponse>, I>>(object: I): QueryConstitutionResponse {
    const message = createBaseQueryConstitutionResponse();
